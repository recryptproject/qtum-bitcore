#ifndef RECRYPTVERSIONCHECKER_H
#define RECRYPTVERSIONCHECKER_H

#include <QObject>

#define RECRYPT_RELEASES "https://github.com/recryptproject/recrypt/releases"
...
class RecryptVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit RecryptVersionChecker(QObject *parent = 0);
    ~RecryptVersionChecker();
