...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RECRYPT");
    case mBTC: return QString("mRECRYPT");
    case uBTC: return QString::fromUtf8("μRECRYPT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Recrypts");
    case mBTC: return QString("Milli-Recrypts (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Recrypts (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
