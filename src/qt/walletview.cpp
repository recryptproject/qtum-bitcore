    ...
    platformStyle(_platformStyle)
{
    ...
    RRCTokenPage = new RRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    RRCTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    RRCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(RRCTokenPage);
    RRCTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(RRCTokenPage);
    RRCTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(RRCTokenPage);
    RRCTokenPage->on_goToAddTokenPage();
}
