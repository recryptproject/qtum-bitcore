...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // recrypt
        hashUTXORoot.SetNull(); // recrypt
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //recrypt
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //recrypt
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //recrypt
    {
